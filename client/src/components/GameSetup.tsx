 ...
 * - Selector de jugadores con animaciones de entrada
 * - Colores vibrantes y contraste alto
 * - Botones con efectos de hover dinámicos
 */
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div className="lg:col-span-2">
        <div className="max-w-2xl">
          ...
          <div className="bg-gradient-to-br from-blue-500/10 to-orange-500/10 border border-blue-500/30 rounded-xl p-8 backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            ...
            <Button
              ...
              className="w-full py-6 text-lg font-bold bg-gradient-to-r from-blue-600 to-orange-600 hover:from-blue-700 hover:to-orange-700 text-white rounded-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 shadow-lg hover:shadow-orange-500/50 hover:scale-105"
            >
              ¡COMENZAR JUEGO!
            </Button>
          </div>
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-200">
            {[
              { step: '1', title: 'Selecciona', desc: 'Elige cuántos jugadores van a participar' },
              { step: '2', title: 'Presiona', desc: 'Cada jugador presiona su carta para ver el futbolista' },
              { step: '3', title: 'Descubre', desc: 'Identifica quién es el impostor' },
            ].map((item) => (
              <div
                key={item.step}
